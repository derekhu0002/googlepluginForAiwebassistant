"""Guardrail: watches python_adapter/app upstream opencode contract mapping so session bootstrap, prompt_async, event normalization, and answer reply remain aligned."""
