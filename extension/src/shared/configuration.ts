...
// Extension targets the local python adapter on :8030; that adapter forwards upstream to opencode on :8124.
const DEFAULT_DEV_API_BASE_URL = "http://localhost:8030";
const DEFAULT_PROD_API_ORIGINS = ["https://api.example.com"];
const DEFAULT_DEV_API_ORIGINS = ["http://localhost:8030"];
